            ...
            <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        ...
                        className={cn("h-10 w-10 rounded-full transition-all", autoScroll && "bg-blue-500/15 text-blue-600 hover:bg-blue-500/25")}
                ...
                {/* Center: Recording Action (Primary) */}
